    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-14 sm:h-16">
            ...
            <a href="/admin/dashboard" class="flex items-center space-x-2">
                ...
                <span class="ml-1 sm:ml-2 text-[10px] sm:text-xs bg-purple-100 text-blue-600 px-2 py-0.5 sm:py-1 rounded-full">
                    Admin
                </span>
            </a>
            ...
            <div class="flex items-center space-x-2 sm:space-x-4">
                ...
                <div class="relative">
                    ...
                    <!-- Dropdown -->
                    <div id="userDropdown" class="absolute right-0 mt-2 w-48 sm:w-56 bg-white rounded-lg shadow-xl hidden">
