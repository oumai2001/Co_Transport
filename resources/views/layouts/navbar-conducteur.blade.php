<!-- Navbar pour Conducteur -->
<nav class="bg-white shadow-lg sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-14 sm:h-16">

            <!-- Logo -->
            <a href="/conducteur/dashboard" class="flex items-center space-x-2">
            ...
            <div class="flex items-center space-x-2 sm:space-x-4">
                ...
                <div class="relative">
                    <button id="userMenuBtn" class="flex items-center space-x-2 sm:space-x-3 p-1.5 sm:p-2 rounded-lg hover:bg-gray-100">
                        ...
                        <!-- Avatar -->
                        <div class="w-7 h-7 sm:w-8 sm:h-8 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xs sm:text-sm">
                    ...
                    <div id="userDropdown" class="absolute right-0 mt-2 w-48 sm:w-56 bg-white rounded-lg shadow-xl hidden z-50">
                        ...
                        <div class="py-2 text-sm sm:text-base">
                            <a href="/profil/modifier" class="flex items-center space-x-3 px-4 py-2 hover:bg-gray-100">
                                 Mon profil
                            </a>

                            <hr>

                            <a href="/logout" class="flex items-center space-x-3 px-4 py-2 text-red-600 hover:bg-red-50">
                                 Déconnexion
                            </a>
                        </div>
